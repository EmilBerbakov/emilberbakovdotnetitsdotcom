...
class LibraryDB extends React.Component {
  ...
  handleSubmit = async (event) => {
    ...
    //TODO: refactor the API call with React-Query
    //TODO: Having the API error out if nothing is found is kind of not good.  Have it send something else instead.
      ...
      <>
        ...
        <PageAnimation>
            ...
            <Row>
              <Col sm="auto">
                ...
                >
                  ...
                  <Dropdown.Item
                    type="button"
                    id="EDITION_ID"
                    onClick={() => searchswitch("EDITION_ID")}
                  >
                    Open Library ID
                  </Dropdown.Item>
              ...
              <Col>
                <Form.Control
                  ...
                  id="searchform"
                  style={{ display: "none" }}
                  onKeyUp={() => visibilityswitch("searchform", "submitbutton")}
                ></Form.Control>
              </Col>
              <Col>
                <Button
          ...
          {this.state.resultArray.length > 0 && (
            <LibraryDBResults props={this.state} />
          )}
        </PageAnimation>
      </>
    );
...
//TODO - the purpose of calling props here, and having the max prop is so that we can shrink the intro upon initiating a database search.
      ...
      <Row>
        <Collapse in={close}>
          <div id="introtext">
            I love to read.
            <br />
            I also love to buy books. Lots and lots of books. This has led to me
            forgetting what I already have when I am browsing the shelves of my
            favorite local bookstore. It was around the time I bought my third
            copy of The Silmarillion that I realized that my library is way too
            big to keep track of in my head. Now, I could write down all of my
            books in the notes app on my phone or use an online library, but
            then I wouldn't be able to flex my technical muscles to create this!
            <br />
            Through this project, affectionately named "Encyclopedia Berb's
            Library Database" users can: <br />
            <ol>
              <li>
                Search the SQL database for books, using both Open Library and
                RESTful to find and compile information within the database
              </li>
              <li>
                Create an account to add books to a personal library,
                categorized by ownership and reading status
              </li>
              <li>
                Keep track of personal libraries and reading progress through
                the database
              </li>
            </ol>
          </div>
